...
public class UpdateCoSign extends Command {
    ...
    public UpdateCoSign(LoanId loanId, CoSignId coSignId, Name name, Email email, Age age) {
        this.loanId = loanId;
    ...
    public CoSignId getCoSignId() {return coSignId;}
