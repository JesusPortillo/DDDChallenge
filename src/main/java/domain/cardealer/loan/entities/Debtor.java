...
public class Debtor extends Entity<DebtorId> {

    protected Name name;
    protected Email email;
    protected Age age;

    public Debtor(DebtorId entityId, Name name, Email email, Age age) {
        super(entityId);
        this.name = name;
        this.email = email;
        this.age = age;
    ...
    public void updateDebtor(Name name, Email email, Age age){
        updateName(name);
        updateEmail(email);
        updateAge(age);
    }
